...
const useTwitchChat = () => {
  ...
  useEffect(() => {
    ...
    window.location.href = `https://id.twitch.tv/oauth2/authorize?response_type=token&client_id=${clientId}&redirect_uri=${window.location.href}&scope=chat%3Aread+user%3Aread%3Aemail`;
